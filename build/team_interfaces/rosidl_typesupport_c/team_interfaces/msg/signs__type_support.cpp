...
static const _Signs_type_support_symbol_names_t _Signs_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, team_interfaces, msg, Signs)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, team_interfaces, msg, Signs)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, team_interfaces, msg, Signs)() {
  return &::team_interfaces::msg::rosidl_typesupport_c::Signs_message_type_support_handle;
}
