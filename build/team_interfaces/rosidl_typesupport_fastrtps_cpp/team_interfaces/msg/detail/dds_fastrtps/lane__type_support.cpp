...
#include "team_interfaces/msg/detail/lane__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const team_interfaces::msg::Lane & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message.right_lane_x_points;
  }
  // Member: right_lane_y_points
  {
    cdr << ros_message.right_lane_y_points;
  }
  // Member: left_lane_x_points
  {
    cdr << ros_message.left_lane_x_points;
  }
  // Member: left_lane_y_points
  {
    cdr << ros_message.left_lane_y_points;
  }
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  team_interfaces::msg::Lane & ros_message)
{
  // Member: right_lane_detected
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  // Member: right_lane_x_points
  {
    ...
    size_t item_size = sizeof(ros_message.right_lane_x_points[0]);
  ...
  // Member: right_lane_y_points
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.right_lane_y_points[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: left_lane_x_points
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.left_lane_x_points[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: left_lane_y_points
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.left_lane_y_points[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = team_interfaces::msg::Lane;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const team_interfaces::msg::Lane *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<team_interfaces::msg::Lane *>(
    untyped_ros_message);
...
{
  return &team_interfaces::msg::typesupport_fastrtps_cpp::_Lane__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, team_interfaces, msg, Lane)() {
  return &team_interfaces::msg::typesupport_fastrtps_cpp::_Lane__handle;
}
