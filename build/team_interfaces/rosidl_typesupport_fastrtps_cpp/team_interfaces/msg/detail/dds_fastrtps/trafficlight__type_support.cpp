...
#include "team_interfaces/msg/detail/trafficlight__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const team_interfaces::msg::Trafficlight & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  team_interfaces::msg::Trafficlight & ros_message)
{
  // Member: traffic_light
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = team_interfaces::msg::Trafficlight;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const team_interfaces::msg::Trafficlight *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<team_interfaces::msg::Trafficlight *>(
    untyped_ros_message);
...
{
  return &team_interfaces::msg::typesupport_fastrtps_cpp::_Trafficlight__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, team_interfaces, msg, Trafficlight)() {
  return &team_interfaces::msg::typesupport_fastrtps_cpp::_Trafficlight__handle;
}
