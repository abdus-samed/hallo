...
#include "team_interfaces/msg/detail/trafficlight__rosidl_typesupport_fastrtps_c.h"
...
using _Trafficlight__ros_msg_type = team_interfaces__msg__Trafficlight;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << (ros_message->traffic_light ? true : false);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: traffic_light
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->traffic_light = tmp ? true : false;
  }
...
size_t get_serialized_size_team_interfaces__msg__Trafficlight(
  const void * untyped_ros_message,
...
static uint32_t _Trafficlight__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_team_interfaces__msg__Trafficlight(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_team_interfaces
size_t max_serialized_size_team_interfaces__msg__Trafficlight(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = team_interfaces__msg__Trafficlight;
    is_plain =
      (
...
static size_t _Trafficlight__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_team_interfaces__msg__Trafficlight(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, team_interfaces, msg, Trafficlight)() {
