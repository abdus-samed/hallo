...
{
  new (message_memory) team_interfaces::msg::Car(_init);
}

void Car_fini_function(void * message_memory)
{
  auto typed_message = static_cast<team_interfaces::msg::Car *>(message_memory);
  typed_message->~Car();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Car_message_member_array[2] = {
  {
    "detected",  // name
    ...
    offsetof(team_interfaces::msg::Car, detected),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(team_interfaces::msg::Car, distance),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Car_message_members = {
  ...
  "Car",  // message name
  2,  // number of fields
  sizeof(team_interfaces::msg::Car),
...
{
  return &::team_interfaces::msg::rosidl_typesupport_introspection_cpp::Car_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, team_interfaces, msg, Car)() {
  return &::team_interfaces::msg::rosidl_typesupport_introspection_cpp::Car_message_type_support_handle;
}
